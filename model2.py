...
def sample_ifaction_train_data(model_train_id_path):
    ifaction_train_id_path = "/home/lab-xu.zeke/ZakeXu/proj/data/self/ifaction_train_id2.txt"
...
def save_feat(ifaction_train_id_path,all_train_feat,all_test_feat):
    ...
    ifaction_train_feat_path = "/home/lab-xu.zeke/ZakeXu/proj/data/self/ifaction_train_feat2.txt"
    ...
    ifaction_test_feat_path = "/home/lab-xu.zeke/ZakeXu/proj/data/self/ifaction_test_feat2.txt"
...
def create_result(pred,test_id_path,test_feat_path):
    ...
    action_test_id_path = "/home/lab-xu.zeke/ZakeXu/proj/result/action_test_id2.txt"
...
def predict(test_id_path,uid_action):
    save_path = "/home/lab-xu.zeke/ZakeXu/proj/result/result_rules2.txt"
...
if __name__ == "__main__":
    ...
    ifaction_train_id2_path = "/home/lab-xu.zeke/ZakeXu/proj/data/self/ifaction_train_id2.txt"
    ...
    ifaction_train_feat2_path = "/home/lab-xu.zeke/ZakeXu/proj/data/self/ifaction_train_feat2.txt"
    ifaction_test_feat2_path = "/home/lab-xu.zeke/ZakeXu/proj/data/self/ifaction_test_feat2.txt"
    action_test_id2_path = "/home/lab-xu.zeke/ZakeXu/proj/result/action_test_id2.txt"
    
    print "sample..."
    sample_ifaction_train_data(model_train_id2_path)
    
    print "extract uid_cid feat of train..."
    uid_cid_feat  = extract_uid_cid_feat(ifaction_train_id2_path,page_view_data_path)
    print "extract all_feat of train..."
    all_train_feat = extract_all_feat(ifaction_train_id2_path,uid_feat_path,txt_feat_path,cluster_feat_path,uid_cid_feat)
    print "extract uid_cid feat of model1..."
    uid_cid_feat  = extract_uid_cid_feat(model_test_id2_path,page_view_data_path)
    print "extract all_feat of model1..."
    all_test_feat = extract_all_feat(model_test_id2_path,uid_feat_path,txt_feat_path,cluster_feat_path,uid_cid_feat)
    print "save feat..."
    save_feat(ifaction_train_id2_path,all_train_feat,all_test_feat)
    
    print "create input and output of model..."
    trainX,trainY,testX = create_input_output(ifaction_train_feat2_path,ifaction_test_feat2_path,"statistic_topic_feat")
    print "model pred..."
    pred = model_pred(trainX,trainY,testX,'rf')
    print "create_result..."
    create_result(pred,model_test_id2_path,ifaction_test_feat2_path)
    print "submit..."
    uid_action = compute_uid_action(model_train_id2_path)
    predict(action_test_id2_path,uid_action)
    print "finish..."
